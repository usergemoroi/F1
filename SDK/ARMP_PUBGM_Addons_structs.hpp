...
{
	class UAnimInstance*                               SourceAnimInstance;                                       // 0x0568(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FName>                               SourceInstancePropertyNames;                              // 0x0570(0x0010) (ZeroConstructor, Transient)
	TArray<class UProperty*>                           SourceInstanceProperty;                                   // 0x0580(0x0010) (ZeroConstructor, Transient)
	TMap<class UAnimInstance*, struct FCopyPropertyData> DestInstancePropertyMap;                                  // 0x0590(0x0050) (ZeroConstructor, Transient)
};
...
struct FAnimNode_GroundIK : public FAnimNode_SkeletalControlBase
{
	...
	struct FFootIKCollision                            FootCollision;                                            // 0x00B0(0x0014) (Edit, BlueprintVisible, DisableEditOnInstance)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00C4(0x0004) MISSED OFFSET
	struct FFootIKSlope                                FootSlope;                                                // 0x00C8(0x0098) (Edit, BlueprintVisible)
	TArray<struct FIKBoneBendDirection>                BendDirections;                                           // 0x0160(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FIKExcludedBone>                     ExcludedBones;                                            // 0x0170(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FIKBoneLimit>                        JointLimits;                                              // 0x0180(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0190(0x0010) MISSED OFFSET
	int                                                MaxSquashIterations;                                      // 0x01A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxStretchIterations;                                     // 0x01A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxFinalIterations;                                       // 0x01A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AllowBoneTranslation;                                     // 0x01AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01AD(0x0003) MISSED OFFSET
	float                                              SolverAlpha;                                              // 0x01B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DebugDrawSize;                                            // 0x01B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UWorld*                                      World;                                                    // 0x01B8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x170];                                     // 0x01C0(0x0170) MISSED OFFSET
};
...
{
	TArray<class UAnimSequence*>                       CandidateSequences;                                       // 0x0168(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FBoneReference>                      ConsideredBones;                                          // 0x0178(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              PositionWeight;                                           // 0x0188(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              VelocityWeight;                                           // 0x018C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PoseInterval;                                             // 0x0190(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0194(0x0004) MISSED OFFSET
	class UAnimPoseRecorder*                           PoseRecorder;                                             // 0x0198(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FAnimJointData>                      AnimJointDatas;                                           // 0x01A0(0x0010) (ZeroConstructor)
...
struct FAnimNode_OffsetRootBone : public FAnimNode_Base
{
	...
	EOffsetRootBoneMode                                RotationMode;                                             // 0x005C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EOffsetRootBoneMode                                TranslationMode;                                          // 0x005D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5A];                                      // 0x005E(0x005A) MISSED OFFSET
	class UWorld*                                      CachedWorldContext;                                       // 0x00B8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
{
	struct FMarkDispatchAction                         MarkDispatchAction;                                       // 0x0000(0x0088)
};
