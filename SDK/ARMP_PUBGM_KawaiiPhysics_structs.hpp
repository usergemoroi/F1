...
struct FNewAnimNode_KawaiiPhysics : public FAnimNode_SkeletalControlBase
{
	...
	struct FVector                                     MaxDistance;                                              // 0x0144(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     MinDistance;                                              // 0x0150(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableWind;                                              // 0x015C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x015D(0x0003) MISSED OFFSET
	float                                              WindScale;                                                // 0x0160(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0164(0x0004) MISSED OFFSET
	TArray<struct FKawaiiPhysicsModifyBone>            ModifyBones;                                              // 0x0168(0x0010) (ZeroConstructor)
	float                                              TotalBoneLength;                                          // 0x0178(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x017C(0x0004) MISSED OFFSET
	struct FTransform                                  PreSkelCompTransform;                                     // 0x0180(0x0030) (IsPlainOldData)
	bool                                               bInitPhysicsSettings;                                     // 0x01B0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3F];                                      // 0x01B1(0x003F) MISSED OFFSET
};
