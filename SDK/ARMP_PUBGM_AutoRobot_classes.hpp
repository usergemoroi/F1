...
{
public:
	TArray<struct FVector>                             PortalLoctions;                                           // 0x0438(0x0010) (Edit, ZeroConstructor)
...
// 0x0010 (0x1098 - 0x1088)
class ATestAIController : public ABaseAIController
{
public:
	class UClass*                                      EquipedWeaponClass;                                       // 0x1088(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      CharacterClass;                                           // 0x1090(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
