...
struct FUserDetailSetting
{
	...
	int                                                UserEnergySaving;                                         // 0x0070(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x558];                                     // 0x0000(0x0558) MISSED OFFSET
	TArray<class UAnimInstance*>                       SubAnimInstances;                                         // 0x0558(0x0010) (ZeroConstructor, Transient)
