...
public:
	...
	bool                                               bStaticAddNetworkActor;                                   // 0x0504(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x0505(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0506(0x0002) MISSED OFFSET
...
public:
	...
	int                                                ModeID;                                                   // 0x04F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x04F4(0x0004) MISSED OFFSET
	struct FString                                     ModType;                                                  // 0x04F8(0x0010) (ZeroConstructor)
	struct FString                                     ModType2;                                                 // 0x0508(0x0010) (ZeroConstructor)
	TArray<struct FString>                             ExtraModules;                                             // 0x0518(0x0010) (ZeroConstructor)
...
public:
	...
	TMap<class UObject*, int>                          InstancedNodeNameToMemoryMap;                             // 0x00D8(0x0050) (ZeroConstructor)
	int                                                InstancedNodesTotalSize;                                  // 0x0128(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x54];                                      // 0x012C(0x0054) MISSED OFFSET
...
{
public:
	class USTBuffCondition*                            Condition;                                                // 0x0078(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              ConditionTickInterval;                                    // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Probality;                                                // 0x0084(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EBuffConditionExecuteTimeType                      ExecuteTimeType;                                          // 0x0088(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDoOnFalse;                                              // 0x0089(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsNeedTick;                                               // 0x008A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsNeedExecute;                                            // 0x008B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSetFalseWhenExecute;                                    // 0x008C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x008D(0x0003) MISSED OFFSET
	TArray<struct FBuffConditionActionItem>            LinkActions;                                              // 0x0090(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
// 0x0360 (0x35A48 - 0x356E8)
class UUAENetConnection : public UIpConnection
{
public:
	unsigned char                                      UnknownData00[0xF4];                                      // 0x356E8(0x00F4) MISSED OFFSET
	int                                                InitialHandshakeTimeoutNumThreshold;                      // 0x357DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x357E0(0x0004) MISSED OFFSET
	int                                                ActorChannelProcessBunchErrorNumThreshold_Server_Global;  // 0x357E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_Global;  // 0x357E8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                ActorChannelProcessBunchErrorNumThreshold_Client_PerActor;// 0x357EC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x50];                                      // 0x357F0(0x0050) MISSED OFFSET
	bool                                               bEnableHTTPDNS;                                           // 0x35840(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x35841(0x0007) MISSED OFFSET
	struct FString                                     HTTPDNSServerAddr;                                        // 0x35848(0x0010) (ZeroConstructor, Config)
	float                                              HTTPDNSResponseTimeout;                                   // 0x35858(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x3585C(0x000C) MISSED OFFSET
	float                                              CheckLevelInitializedTime;                                // 0x35868(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CheckLevelActorsOvertime;                                 // 0x3586C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              TempCheckLevelInitializedTime;                            // 0x35870(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x35874(0x0004) MISSED OFFSET
	TMap<struct FName, struct FUnLoadLevelActorCollection> UnLevelInitActors;                                        // 0x35878(0x0050) (ZeroConstructor)
	class UNetRelevancyGroup*                          RelevancyGroup;                                           // 0x358C8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x100];                                     // 0x358D0(0x0100) MISSED OFFSET
	TArray<struct FPendingRegionNetworkObject>         PendingRegionNetworkObjects;                              // 0x359D0(0x0010) (ZeroConstructor)
	float                                              MinRegionActorTickDelta;                                  // 0x359E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxRegionActorTickDelta;                                  // 0x359E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0xC];                                       // 0x359E8(0x000C) MISSED OFFSET
	bool                                               EnableWeakNetUpdate;                                      // 0x359F4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x359F5(0x0003) MISSED OFFSET
	float                                              MinWeakNetUpdateDelay;                                    // 0x359F8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxWeakNetUpdateDelay;                                    // 0x359FC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              SquareSegmentSize;                                        // 0x35A00(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              MaxSegmentDistance;                                       // 0x35A04(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                MaxObjectNumInSegments;                                   // 0x35A08(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData09[0x15];                                      // 0x35A0C(0x0015) MISSED OFFSET
	bool                                               bRecreateSocketOnLost;                                    // 0x35A21(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x12];                                      // 0x35A22(0x0012) MISSED OFFSET
	float                                              UpdateClientPingTimeThreshold;                            // 0x35A34(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x10];                                      // 0x35A38(0x0010) MISSED OFFSET
...
public:
	...
	bool                                               bSpeedUpLoadLocalizationText;                             // 0x035A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0xD];                                       // 0x035B(0x000D) MISSED OFFSET
	...
	struct FString                                     SplitModTableRelativeDir;                                 // 0x0388(0x0010) (ZeroConstructor, Config)
	TArray<struct FString>                             BaseModTableConfig;                                       // 0x0398(0x0010) (ZeroConstructor, Config)
	TMap<struct FName, class UModTable*>               ModTableMap;                                              // 0x03A8(0x0050) (ZeroConstructor)
	TMap<struct FName, TWeakObjectPtr<class UUAEDataTable>> ModTableObjMap;                                           // 0x03F8(0x0050) (ZeroConstructor)
	TArray<class UUAEDataTable*>                       InGameTableObjList;                                       // 0x0448(0x0010) (ZeroConstructor)
	TMap<struct FName, bool>                           CheckNeedModMap;                                          // 0x0458(0x0050) (ZeroConstructor)
	struct FString                                     CurrentModName;                                           // 0x04A8(0x0010) (ZeroConstructor)
	struct FString                                     EmptyModName;                                             // 0x04B8(0x0010) (ZeroConstructor)
	TMap<struct FString, class UBaseTableResMap*>      LoadedTableMap;                                           // 0x04C8(0x0050) (ZeroConstructor)
	TMap<struct FString, bool>                         CheckMapTable;                                            // 0x0518(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x60];                                      // 0x0568(0x0060) MISSED OFFSET
