...
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x2218(0x0008) MISSED OFFSET
...
// 0x0090 (0x1558 - 0x14C8)
class APlanPH_GameState : public ASTExtraGameStateBase
{
public:
	struct FScriptMulticastDelegate                    OnIslandPlayerChangeDelegate;                             // 0x14C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FPlanPH_CommonOccupy                        PartyDanceLeadInfo_2;                                     // 0x14D8(0x0020) (Net)
	struct FPlanPH_CommonOccupy                        PartyDanceLeadInfo_3;                                     // 0x14F8(0x0020) (Net)
	struct FPlanPH_CommonOccupy                        PartyDanceLeadInfo_4;                                     // 0x1518(0x0020) (Net)
	struct FPlanPH_CommonOccupy                        PartyDanceLeadInfo_5;                                     // 0x1538(0x0020) (Net)
...
{
public:
	int                                                LandId;                                                   // 0x1BF8(0x0004) (BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x1BFC(0x0004) MISSED OFFSET
