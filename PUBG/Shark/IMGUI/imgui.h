...
namespace ImGui
{
    ...
    IMGUI_API void          EndGroup();
	 ...
	 IMGUI_API void          EndGroupPanel();                                                     // unlock horizontal starting position + capture the whole group bounding box into one "item" (so you can use IsItemHovered() or layout primitives such as SameLine() on whole group, etc.)
